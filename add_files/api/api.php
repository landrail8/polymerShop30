...
if((isset($_POST['accountEmail'])&&$_POST['accountEmail']!="")){ //Проверка отправилось ли наше поля name и не пустые ли они
    $to = $_POST['accountEmail']; //Почта получателя, через запятую можно указать сколько угодно адресов
    ...
    $headers .= "From: Ваш Хюгге <mail@hygge-dukon.ru>\r\n"; //Наименование и почта отправителя
    $headers .= "Reply-To: <mail@hygge-dukon.ru>\r\n";
