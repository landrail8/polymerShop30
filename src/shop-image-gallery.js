...
class ShopImageGallery extends PolymerElement {
  static get template() {
    return html`
    <style>
  ...
  <!--
    <iron-image placeholder="https://source.unsplash.com/category/nature/10x10"
        data-src="https://source.unsplash.com/category/nature/100x100"
        sizing="cover"
        preload
        fade
        ></iron-image>
    <iron-image placeholder="https://source.unsplash.com/category/food/100x100"
        data-src="[[gallery[1]]]"
        sizing="cover"
        preload
        fade
        ></iron-image>
    <iron-image placeholder="https://source.unsplash.com/category/buildings/200x200"
        data-src="[[gallery[2]]]"
        sizing="cover"
        preload
        fade
...
`;
  ...
  static get is() { return 'shop-image-gallery'; }
...
customElements.define(ShopImageGallery.is, ShopImageGallery);
